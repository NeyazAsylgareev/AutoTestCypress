describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('neyaz515@yandex.ru');                   // вводим логин
         cy.get('input[id="k_password"]').type('199123Aa@');               // вводим пароль
         ...
         cy.get('.available > button').last().click();   // кликаем Купить у последнего из доступных аватаров
